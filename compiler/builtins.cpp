...
Builtins::Builtins(::llvm::Module* module)
    : ctx_(module->getContext()), module_(module) {}

void Builtins::SetupBuiltinTypes() {
  types.class_desc_ty =
      ::llvm::StructType::create(ctx_, "__quo_ClassDescriptor");
  ...
  types.class_view_ty =
      ::llvm::StructType::create(ctx_, class_view_fields, "__quo_ClassView");
  ...
  types.class_desc_ty->setBody(class_desc_fields,
                               false);  // isPacked
...
void Builtins::SetupBuiltinFunctions() {
  ...
  fns.quo_inc_refs = module_->getOrInsertFunction(
      "__quo_inc_refs",
      ::llvm::FunctionType::get(
          ::llvm::Type::getVoidTy(ctx_), {::llvm::Type::getInt8PtrTy(ctx_)},
          false));  // isVarArg
  ...
  fns.quo_print = module_->getOrInsertFunction(
      "__quo_print", ::llvm::FunctionType::get(
