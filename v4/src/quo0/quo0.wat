(module
  ...
  (global $runtime (mut i32) (i32.const 0))
  (func $compileModule (result i32)
    ...
    ;; Prologue
    (call $strcpy (local.get $outputPtr) (i32.const 131072) (i32.const 15731844))
    (call $strcat (local.get $outputPtr) (i32.const 131072) (global.get $runtime))
    ...
    (call $strcat (local.get $outputPtr) (i32.const 131072) (i32.const 15729792))
    (local.get $outputPtr)
  )
  ...
  (func $init (param $input i32)
    ;; Set initial memory offset to after input string + runtime string.
    (global.set
        $runtime
        (i32.add (call $strlen (local.get $input)) (i32.const 1)))
    (global.set
        $memoryOffset
        (i32.add (call $strlen (global.get $runtime)) (i32.const 1)))
    ...
    (global.set $stringOffset (i32.const 15728640))
    ;; Loop counter.
